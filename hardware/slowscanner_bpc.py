...
class SlowScanner(Base, ConfocalScannerInterface):
    ...
    def set_up_scanner(self,
        ...
        decrypted["user_platform"] = 'slowscanner'
    ...
    def scan_image(self):
        ...
        try:
            ...
            counts_out = np.ones((1, samples), dtype=np.uint32) * -1
