...
class ODMRGui(GUIBase):
    ...
    def on_activate(self):
        ...
        *.ui file and configures the event handling between the modules.
        ...
        self._mw.step_freq_DoubleSpinBox.setMinimalStep(1.0)  # set the minimal step to 1Hz
        ...
        self._mw.cw_power_DoubleSpinBox.setMinimalStep(0.1)
        ...
        self._mw.sweep_power_DoubleSpinBox.setMinimalStep(0.1)
